...
> [!info] Definição
> As **atividades** quando realizadas avançamos nprojeto

O estado das execuções são alterados pelos rituais de [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/Rituais/📆 Levantamento de atividades|📆 Levantamento de atividades]] e [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/Rituais/🔬 Refinamento|🔬 Refinamento]].
...
- **Estado** - Estado da execução no fluxo de trabalho.
	- [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🔃 Fluxo de trabalho/🔃 Fluxo de trabalho|🔃 Fluxo de trabalho]] da [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🚧 Atividade|🚧 Atividade]] define o que cada estado representa
...
- **Pode elencar?**
	...
	- Se existir Valor, ele deve estar pronto para ter uma atividade elencada (propriedade do [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🏆 Épico/🏆 Épico|🏆 Épico]] `Pronto para puxar 🚧 Atividade`)
...
O conteúdo de uma [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🚧 Atividade]] muda de acordo com o seu [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🍱 Tipos de Atividades]], principalmente dependendo do tipo de atividades temos um tratamento diferente para sua execução.
...
- **Conclusão** - Um pequeno texto para descrever resultados, aprendizados e considerações sobre a [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🚧 Atividade]]
	- Utilizado principalmente no rituais de [[🌀 Retrospectiva]] para entender o que foi feito
	- Também pode ser utilizado para criar novas [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🚧 Atividade|🚧 Atividade]] dada as necessidades levantadas na conclusão.
...
- **Refinamento** - O que preciso antes da realização dessa execução?
	...
	- Utilizado principalmente quando em [[Gestão de projetos/Organização em times pequenos/Tarefas/Modelo simplificado (v2)/🚧 Atividade/🔃 Fluxo de trabalho/Atividade Refinando|Atividade Refinando]]
