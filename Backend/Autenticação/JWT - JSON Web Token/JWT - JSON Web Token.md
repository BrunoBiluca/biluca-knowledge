...
O JWT é uma forma de autenticação em resposta ao Cookies mais tradicionais que apresentavam várias limitações, como cookies criados pelo backend são considerados de terceiros pelo Browser e podem ser facilmente desabilitados.
