...
> Para isso é necessário um [[Engenharia de Dados/Streamlit/Widgets]] de entrada. Por exemplo, quando uma tab é exibida, não é possível associar um callback para carregar dados específicos.
