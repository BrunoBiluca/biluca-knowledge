...
UDF são funções definidas pelo usuário, são principalmente utilizadas para extender as [[Engenharia de Dados/Apache Spark/Transformações/Transformações|Transformações]] nativas e reutilizar essas funções em múltiplos [[DataFrame]].
